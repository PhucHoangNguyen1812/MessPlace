...
public class ChuyenDoiTinNhanDiaDiem extends RecyclerView.Adapter {
    ...
    ArrayList<NguoiDung> listHienTai;
    String tennggui;

    public void setListHienTai(ArrayList<NguoiDung> listHienTai) {
        this.listHienTai = listHienTai;
    }
    ...
    public ChuyenDoiTinNhanDiaDiem(Context context, String maSoNguoiGui, ArrayList<TinNhan> tinNhans) {
    ...
    public ChuyenDoiTinNhanDiaDiem(){}
